...
DATABASES_URL="PGPASSWORD=spHAUMIuenmqpfUqL9wY psql -h containers-us-west-52.railway.app -U postgres -p 5497 -d railway"
...
DATABASES={dj_database_url.config(default=DATABASES_URL,conn_max_age=1800),}
